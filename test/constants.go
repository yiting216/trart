...
const (
	...
	_setNonExclusiveNFTCdcPath   = _projectRootPath + "/transactions/set_nonexclusive_nft.cdc"
	...
	_queryNonExclusiveNFTCdcPath = _projectRootPath + "/scripts/read_nonexclusive_ids.cdc"
